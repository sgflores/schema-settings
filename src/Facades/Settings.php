 ...
 * @method static array getMultiple(array $keys, Model|null $model = null) Get multiple settings
 * @method static bool setMultiple(array $settings, Model|null $model = null) Set multiple settings
 * @method static array all(Model|null $model = null) Get all settings for a scope
